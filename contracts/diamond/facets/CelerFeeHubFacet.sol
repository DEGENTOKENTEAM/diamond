...
import { FeeConfigSyncDTO, FeeSyncQueue, FeeConfig, FeeConfigSyncHomeDTO } from "./../helpers/Structs.sol";
import { AlreadyInitialized, NotAllowed, ZeroValueNotAllowed, WrongChain } from "./../helpers/GenericErrors.sol";
